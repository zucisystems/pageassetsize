...
public class WriteToExcel {
	...
	public void writeToExcel(HSSFSheet sheet1,HSSFSheet sheet2, long[] a, String tempSlNo, String tempURL, String tempua, int writeExcelCounter){
        ...
        if(!headerCreated){
	        ...
	        rowhead.createCell(2).setCellValue("User Agent");
	        rowhead.createCell(3).setCellValue("HTML Size (in KB)");
	        rowhead.createCell(4).setCellValue("CSS Size (in KB)");
	        rowhead.createCell(5).setCellValue("JS Size (in KB)");
	        rowhead.createCell(6).setCellValue("XHR Size (in KB)");
	        rowhead.createCell(7).setCellValue("Image Size (in KB)");
	        rowhead.createCell(8).setCellValue("Media Size (in KB)");
	        rowhead.createCell(9).setCellValue("Font Size (in KB)");
	        rowhead.createCell(10).setCellValue("Other Size (in KB)");
	        headerCreated = true;
        }
        	...
        	rowhead.createCell(2).setCellValue(tempua);
        	rowhead.createCell(3).setCellValue(a[0]);
        	rowhead.createCell(4).setCellValue(a[1]);
        	rowhead.createCell(5).setCellValue(a[2]);
        	rowhead.createCell(6).setCellValue(a[3]); 
        	rowhead.createCell(7).setCellValue(a[4]);  
        	rowhead.createCell(8).setCellValue(a[5]);  
        	rowhead.createCell(9).setCellValue(a[6]);  
        	rowhead.createCell(10).setCellValue(a[7]);
